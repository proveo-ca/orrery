    ...
    function e(e) {
      ...
      if (u) {
        ((a = o ? require("path").dirname(a) + "/" : __dirname + "/"),
          ...
          (L = function (e, t) {
            return (U(), (e = B.normalize(e)), n.readFileSync(e, t ? void 0 : "utf8"));
          }),
      ...
      if (
        ...
        !(
          (g = new WebAssembly.Memory({ initial: p / 65536, maximum: 32768, shared: !0 }))
                    ...
                    : "cleanupThread" === n
                      ...
                      : "killThread" === n
                        ...
                        : "cancelThread" === n
                          ...
                          : "loaded" === n
                            ? ((r.loaded = !0), a && a(r), r.ja && (r.ja(), delete r.ja))
                            : "print" === n
      ...
      function Se(e) {
        ...
        var n = (E.ea[e.ta] = { worker: t, va: e.ta }),
          r = ((t.ga = n), { cmd: "run", start_routine: e.Na, arg: e.ia, threadInfoStruct: e.ta });
        return (
          (t.ja = () => {
                ...
                ? ((s = h()[(s.oa + 8) >> 2]),
                  ...
                  ye(function () {
                    var e,
                      t = j(12),
                      n = 0;
                    (a && ((n = oe(a) + 1), (e = ut(n)), w(a, l(), e, n), (n = e)),
                      (h()[t >> 2] = n),
                      (h()[(t + 4) >> 2] = o),
                      (h()[(t + 8) >> 2] = i),
      ...
      function qe(n, e) {
        n.wa ||
          ...
          (n.getContext = function (e, t) {
            return ("webgl" == e) == (t = n.wa(e, t)) instanceof WebGLRenderingContext ? t : null;
          }));
        var t,
          r,
          a,
      ...
      function Ge(e, t, n, r) {
        ...
        for (var a = 0, o = 0; o < n; o++) {
          ...
          for (var u = 0; u < s; u++) {
            var c = l()[i + u],
              f = Me[e];
            0 === c || 10 === c ? ((1 === e ? Q : m)(ae(f, 0)), (f.length = 0)) : f.push(c);
          }
          a += s;
        }
        return ((h()[r >> 2] = a), 0);
      ...
      function Xe(e, t, n, r) {
        ...
        var l,
          ...
          f = {
            ...
            "%I": function (e) {
              return (0 == (e = e.qa) ? (e = 12) : 12 < e && (e -= 12), o(e, 2));
            },
            "%j": function (e) {
              ...
              return i(n, (e = new Date(e.da + 1900, e.ha, e.la))) < 0
                ? o(
                    Math.ceil(
                      (31 -
                        n.getDate() +
                        (ze(R(e.getFullYear()) ? T : C, e.getMonth() - 1) - 31) +
                        e.getDate()) /
                        7,
                    ),
                    2,
            ...
            "%W": function (e) {
              var t = new Date(e.da, 0, 1),
                n = 1 === t.getDay() ? t : Qe(t, 0 === t.getDay() ? 1 : 7 - t.getDay() + 1);
              return i(n, (e = new Date(e.da + 1900, e.ha, e.la))) < 0
                ? o(
                    Math.ceil(
                      (31 -
      ...
      var Je,
        ...
        Ze = {
              ...
              : ((a = []),
                d && 0 === a.length
                  ...
                  : ((e = { Na: n, ta: e, ia: r, Sa: a }),
                    d ? ((e.Ta = "spawnThread"), postMessage(e, a), 0) : Se(e)));
          },
          g: ke,
          o: Ee,
          v: De,
          ...
          w: function (e, t, n) {
            ...
            for (I.length = 0, n >>= 2; (r = l()[t++]); )
              ((r = r < 105) && 1 & n && n++, I.push(r ? P()[n++ >> 1] : h()[n]), ++n);
            return d ? O.apply(null, [-1 - e, 0].concat(I)) : _e[e].apply(null, I);
          },
          h: function () {
            u ||
              o ||
          ...
          q: function () {
            return u ? require("os").cpus().length : navigator.hardwareConcurrency;
          },
          D: function (e, t, n) {
            ((Oe.length = t), (n >>= 3));
        ...
        $e =
          (!(function () {
            ...
            var a = { a: Ze };
            if (
              (d || (x++, c.monitorRunDependencies && c.monitorRunDependencies(x)),
              c.instantiateWasm)
            )
              try {
        ...
        tt =
          ((c.__emscripten_thread_crashed = function () {
            return (c.__emscripten_thread_crashed = c.asm.N).apply(null, arguments);
          }),
          ...
          (c.__emscripten_thread_init = function () {
            return (tt = c.__emscripten_thread_init = c.asm.P).apply(null, arguments);
          })),
        nt =
          ((c._emscripten_current_thread_process_queued_calls = function () {
            return (c._emscripten_current_thread_process_queued_calls = c.asm.Q).apply(
              null,
              arguments,
            );
          }),
          (c._emscripten_sync_run_in_main_thread_4 = function () {
            return (nt = c._emscripten_sync_run_in_main_thread_4 = c.asm.R).apply(null, arguments);
          })),
        rt = (c._emscripten_main_thread_process_queued_calls = function () {
          return (rt = c._emscripten_main_thread_process_queued_calls = c.asm.S).apply(
            null,
            arguments,
          );
        }),
        at = (c._emscripten_run_in_main_runtime_thread_js = function () {
          return (at = c._emscripten_run_in_main_runtime_thread_js = c.asm.T).apply(
            null,
            arguments,
          );
        }),
        ot = (c._emscripten_dispatch_to_thread_ = function () {
          return (ot = c._emscripten_dispatch_to_thread_ = c.asm.U).apply(null, arguments);
        }),
        it = (c.__emscripten_thread_free_data = function () {
          return (it = c.__emscripten_thread_free_data = c.asm.V).apply(null, arguments);
        }),
        st =
          ((c.__emscripten_thread_exit = function () {
            return (c.__emscripten_thread_exit = c.asm.W).apply(null, arguments);
          }),
        ...
        ct = (c._emscripten_stack_set_limits = function () {
          return (ct = c._emscripten_stack_set_limits = c.asm._).apply(null, arguments);
        }),
        ...
        dt = (c.__emscripten_allow_main_runtime_queued_calls = 6678352);
      function q(e) {
      ...
      function pt(o) {
        function e() {
          if (!Je && ((Je = !0), (c.calledRun = !0), !K)) {
            if (
              (d || k(fe), d || k(le), F(c), c.onRuntimeInitialized && c.onRuntimeInitialized(), ht)
            ) {
              var e = o,
      ...
      function mt(e) {
        ...
        (b() || d || E.ua(), b() || (E.ua(), c.onExit && c.onExit(e), (K = !0)), r(e, new q(e)));
      }
      if (
      ...
      a.length &&
        ...
        (function e() {
          for (var t; n < a.length; ) {
            if ((t = a[n++]).startsWith("sleep ")) return setTimeout(e, t.slice(6));
            l(t);
          }
        })()));
  }
        ...
        (function (t) {
          return function (e) {
            (++r,
              (a[t] = e),
              r === n &&
                ((e = URL.createObjectURL(new Blob(a, { type: "application/wasm" }))), u(e)));
          };
        })(e),
      );
  }
        ...
        e
          ? require.main === module
            ? ((c = require("path")),
              ...
              require("readline")
                ...
                .on("line", function (e) {
                  e &&
                    (r.processCommand ? r.processCommand(e) : a.push(e), "quit" === e) &&
                    process.exit();
                })
                .on("close", function () {
                  process.exit();
          ...
          : ((e = self.location.hash.substr(1).split(",")),
            ...
            (onmessage =
              ...
              function (e) {
                if (
                  (r.processCommand ? r.processCommand(e.data) : a.push(e.data), "quit" === e.data)
                )
                  try {
                    self.close();
                  } catch (e) {}
